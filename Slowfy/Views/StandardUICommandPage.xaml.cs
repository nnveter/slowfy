...
namespace XamlBrewer.WinUI3.Navigation.Sample.Views
{
    ...
    public sealed partial class UI : Page
    {
        ...
        private static void ListViewRight_ContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
        {
